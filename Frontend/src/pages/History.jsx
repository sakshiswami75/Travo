      ...
      <main className="max-w-4xl mx-auto px-margin-mobile py-stack-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-gutter mb-stack-lg">
          <div className="relative flex-1">
            ...
            <input type="text" placeholder="Search reports (e.g., 'Main Street')" className="w-full bg-[#F9FAFB] border-none rounded-[16px] pl-12 pr-4 h-[56px] text-body-md font-body-md text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary focus:bg-surface transition-all shadow-sm" />
          </div>
              ...
              <button 
                ...
                className={`px-4 h-[48px] rounded-full text-label-bold font-label-bold shadow-sm whitespace-nowrap flex items-center gap-2 shrink-0 transition-colors ${
                  filter === f 
                    ...
                    : 'bg-[#F9FAFB] text-on-surface-variant border border-outline-variant/30 hover:bg-surface-container'
                }`}
              >
                {f}
              </button>
        ...
        <div className="space-y-stack-lg">
          ...
          <div>
            ...
            <div className="space-y-gutter">
              {/* Item 1 */}
              <div className="bg-surface rounded-[16px] border border-[#F3F4F6] p-5 shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] transition-shadow flex gap-4 items-start group">
